...
export const kinematics = {
    ...
    concepts: [
        // ============ BASIC CONCEPTS ============
        {
            ...
            tags: ["kinematics", "linear-motion", "vectors", "conceptual"],
            difficulty: "Easy",
            relatedConcepts: ["KIN02", "KIN06"],
            prerequisites: [],
        ...
        },
        {
            ...
            uid: "KIN02",
            subtopic: "Basic Concepts",
            tags: ["kinematics", "linear-motion", "calculus", "graphs"],
            difficulty: "Easy",
            relatedConcepts: ["KIN01", "KIN03", "KIN04", "KIN05"],
            prerequisites: ["KIN01"],
        ...
        },
        {
            ...
            uid: "KIN03",
            subtopic: "Basic Concepts",
            tags: ["kinematics", "linear-motion", "numerical", "jee-mains"],
            difficulty: "Medium",
            relatedConcepts: ["KIN02", "KIN04"],
            prerequisites: ["KIN02"],
        ...
        },
        {
            ...
            uid: "KIN04",
            subtopic: "Basic Concepts",
            tags: ["kinematics", "linear-motion", "numerical"],
            difficulty: "Easy",
            relatedConcepts: ["KIN02", "KIN03"],
            prerequisites: ["KIN02"],
        ...
        },
        {
            ...
            uid: "KIN05",
            subtopic: "Basic Concepts",
            tags: ["kinematics", "linear-motion", "calculus", "graphs", "vectors"],
            difficulty: "Medium",
            relatedConcepts: ["KIN02", "KIN06", "KIN07"],
            prerequisites: ["KIN02"],
        ...
        },
        {
            ...
            uid: "KIN06",
            subtopic: "Basic Concepts",
            tags: ["kinematics", "linear-motion", "conceptual", "circular-motion"],
            difficulty: "Easy",
            relatedConcepts: ["KIN01", "KIN05", "KIN35"],
            prerequisites: ["KIN01", "KIN05"],
